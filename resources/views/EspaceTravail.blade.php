 ...
 @section('content')
     <div class="h-screen bg-[#d3e7ff]  flex">
         {{-- side bar --}}
         <div
             class="h-screen side-bar  bg-white w-[7%] side-bar flex flex-col gap-10 align-items-center  rounded-2xl text-gray-500">
             ...
             <a href="" class="text-[#00b1ff]"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
             ...
             <a href="{{ route('profile.edit') }}" class="text-[#00b1ff]"><svg xmlns="http://www.w3.org/2000/svg"
                     width="30" height="30" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                     <path
             ...
             <a href=""><svg xmlns="http://www.w3.org/2000/svg" class="text-[#00b1ff]" width="30" height="30"
         ...
         <div>
             ...
             <div class="flex">
                 <h1>hi <span class="font-mono fw-bolder">{{ Auth::user()->name }}</span> </h1>
