 ...
 @section('content')
     ...
     <div class="h-screen bg-[#f2f7ff]  flex">
         {{-- side bar --}}
        <div
         class="h-screen  bg-white w-[4%]  side-bar flex flex-col gap-16 align-items-center  rounded-2xl text-gray-500">
         <a href="{{ route('dashboard') }}" class="mt-2 text-[#4f6771]"> <svg xmlns="http://www.w3.org/2000/svg"
                 width="28" class="mt-4" height="30" fill="currentColor" class="bi bi-house-add-fill" viewBox="0 0 16 16">
                 <path
         ...
         <a href="{{ route('chatify') }}" class="text-[#4f6771]"><svg xmlns="http://www.w3.org/2000/svg"
                 width="28" height="28" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
                 <path
         ...
         <a href="{{ route('profile.edit') }}" class="text-[#4f6771]"><svg xmlns="http://www.w3.org/2000/svg"
                 width="28" height="28" fill="currentColor" class="bi bi-person-lines-fill"
                 viewBox="0 0 16 16">
                 <path
         ...
         <a href=""><svg xmlns="http://www.w3.org/2000/svg" class="text-[#4f6771]" width="28"
                 height="28" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
                 <path
...
<div class="flex flex-col">
    ...
    <div class=" p-8">
        <div class="flex  gap-2 ">
            ...
            <h1 class="font-semibold font-mono ">Create Task </h1> <svg xmlns="http://www.w3.org/2000/svg" class="mt-2" width="26" height="26" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
            ...
            {{-- <div class="flex flex-wrap gap-4 px-3 tasks"> --}}
                ...
                {{-- creer la tache --}}
                    ...
                    {{-- <form action="{{ route('tache.store') }}" class="flex flex-col flex-wrap form hidden" method="POST">
                         @csrf
                         <input type="text" name="name" placeholder="le titre de la liste">
                         <input type="text" placeholder="description" name="description"
                         placeholder="le titre de la liste">
                         <input type="datetime-local" placeholder="datestart" name="dateStart">
                         <input type="datetime-local" placeholder="dateEnd" name="dateEnd">
                         <select name="priority" class="text-black" id="">
                             <option value="low"></option>
                             <option value="medium" selected></option>
                             <option value="high"></option>
                         </select>
                         <button class="bg-blue-500 button-create w-[7vw]  mt-2 py-2">Ajouter une liste</button>
                 ...
                 <div class="bg-white mini-task shadow-2xl h-fit w-[20vw] py-3 px-3 flex gap-2 rounded-2xl">
                     ...
                     class="bi bi-pencil edit-icon" viewBox="0 0 16 16" data-task-id="{{ $tache->id }}">
                     <path
                                 d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325" />
                         </svg>
                         <p>{{ $tache->name }}</p>
                         <form action="{{ route('tache.store', $tache->id) }}" method="POST" class="edit-form hidden">
                             @csrf
                             @method('PUT')
                             <input type="text" name="name" value="{{ $tache->name }}" class="edit-input">
     ...
     <div class="py-7 h-screen w-[90vw] flex gap-5 justify-around">
         <div class="bg-blue-300 w-[33%] flex flex-col "> <h2 class="font-extrabold text-start px-2">To Do</h2> </div>
         <div class="bg-blue-300 w-[33%] flex flex-col "> <h2 class="font-extrabold text-start px-2">in Progress</h2> </div>
         <div class="bg-blue-300 w-[33%] flex flex-col "> <h2 class="font-extrabold text-start px-2">Done</h2> </div>
     ...
     {{-- <script>
         let myBtn = document.querySelector('.ajouter');
